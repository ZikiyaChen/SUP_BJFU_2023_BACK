...
def job_refresh_lesson():
    ...
    lesson_info = {'term': '2022-2023-2', 'host': 'localhost', 'user': 'root', 'passwd': 'bjfu@2022', 'db': 'supervision',
            'charset': 'utf8'}
...
schedule.every().day.at("21:00").do(refresh_lesson_record.inser_lesson_record)
